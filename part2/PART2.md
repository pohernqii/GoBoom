...
2  | 1211101775    |   LAM YUET XIN   |   --Reset the game. All scores become zero. Round and trick number restart
from 1.
-Automatically skip player's turn if the deck is empty                |25
